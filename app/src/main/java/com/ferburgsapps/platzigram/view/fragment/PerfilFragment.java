package com.ferburgsapps.platzigram.view.fragment;
...
public class PerfilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseCrash.log("Inicializando PerfilFragment");
    ...
    public ArrayList<PicCard> buidPictures(){
        ...
        pictures.add(new PicCard("http://www.educationquizzes.com/library/KS3-Geography/river-1-1.jpg", "Anahi Salgado", "2 días", "9 Me Gusta"));
        return pictures;
    }
